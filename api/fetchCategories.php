...
function ced_amazon_fetch_next_level_category( $request_body ) {
    ...
    if ( 4 == $next_level ) {
        ...
        $product_template = $upload_dir . '/ced-amazon/templates/' . $userCountry . '/' . $category_id . '/products_template_fields.json';
        ...
        // save profile
        $dirname           = $upload_dir . '/ced-amazon/templates/' . $userCountry . '/' . $category_id . '/' . $sub_category_id;
        $fileName          = $dirname . '/products.json';
        $valid_values_file = $upload_dir . '/ced-amazon/templates/' . $userCountry . '/' . $category_id . '/valid_values.json';
